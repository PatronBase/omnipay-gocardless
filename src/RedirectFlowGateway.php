...
class RedirectFlowGateway extends AbstractGateway
{
   ...
   * @param array $parameters
   *
   * @return Message\CompleteRedirectFlow|Message\AbstractRequest|RedirectFlowGateway
   */
  public function completePurchase(array $parameters = [])
  {
    return $this->createRequest(Message\CompleteRedirectFlow::class, $parameters);
  }
}
